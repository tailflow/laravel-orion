...
use Orion\ValueObjects\Specs\Requests\Relations\ManyToMany\DetachRequest;
...
use Orion\ValueObjects\Specs\Responses\Success\Relation\ManyToMany\DetachResponse;

class DetachOperationBuilder extends RelationOperationBuilder
{
    /**
     * @return Operation
    ...
    public function build(): Operation
    {
        ...
        $operation->summary = "Detach {$this->resolveResourceName(true)}";
    ...
    protected function responses(): array
    {
        ...
        return [
            new DetachResponse($resourceModel),
